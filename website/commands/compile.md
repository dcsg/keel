...
Run after:
- Capturing a new ADR with `/keel:adr`
- Adding an invariant with `/keel:invariant`
...
- [/keel:review-governance](/commands/review-governance) — review compiled output for language quality
- [/keel:adr](/commands/adr) — capture an architecture decision
- [/keel:invariant](/commands/invariant) — add a hard constraint
